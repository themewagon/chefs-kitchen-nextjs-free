      ...
      <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md '>
        <div className='bg-primary rounded-Newsletter grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8'>
          ...
          <div className='col-span-5 relative hidden md:block'>
            <div>
              <Image
                src={`${getImagePrefix()}images/Newsletter/soup.svg`}
                alt='soup-image'
                width={626}
                height={602}
                className='-mt-24'
            ...
            <div className='absolute top-[78%]'>
              <Image
                src={`${getImagePrefix()}images/Newsletter/onion.svg`}
                alt='onion-image'
                width={300}
                height={122}
              />
            ...
            <div className='absolute top-[30%] right-[-23%] hidden lg:block'>
              <Image
                src={`${getImagePrefix()}images/Newsletter/lec.svg`}
                alt='lettuce-image'
                width={300}
                height={122}
              />
            ...
            <div className='absolute bottom-[10%] left-[0%]'>
              <Image
                src={`${getImagePrefix()}images/Newsletter/yellow.svg`}
                alt='yellow-image'
                width={59}
                height={59}
              />
            ...
            <div className='absolute bottom-[20%] right-[20%]'>
              <Image
                src={`${getImagePrefix()}images/Newsletter/blue.svg`}
                alt='blue-image'
                width={25}
                height={25}
              />
